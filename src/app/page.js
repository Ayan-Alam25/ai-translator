...
import VoiceRecoder from "@/app/components/voice-recorder";
          ...
          <div className="flex flex-col gap-8 row-start-2 items-center sm:items-start w-full">
            ...
            >
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="container flex flex-col">
                  ...
                  <textarea
                    ...
                    className="border text-black border-slate-800 rounded-md p-4"
                    value={inputText}
                    name="text"
                    required
              ...
              <div className="flex flex-row items-center gap-2 h-16">
                ...
                {languageFrom === "en" && (
                  <VoiceRecoder handleSetText={handleInputSet} />
                )}
              </div>
            </form>
          </div>
